...
export const CHANGELOG_DATA: ChangelogEntry[] = [
  {
    ...
    date: '2026-09-06',
    content: {
      en: `- ✨ Fix OOM issue when loading sub-agents in large conversation scenarios (147aef9)
...
- [fix] Fix inconsistent donation-QR display (e18817d)`,
      zh: `- ✨修复OOM问题，大型对话场景，加载子代理 (147aef9)
...
- 🐛 修复问题卡片状态问题，隐藏未开发的下载会话按钮 (077f2d8)`,
  ...
  },
  {
    ...
    date: '2026-09-02',
    content: {
      en: `- [add] Fix plugin name (d658666)
